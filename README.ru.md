...
# установите study-coach и скажите «хочу выучить X» (или /study-coach) в новой сессии
```

Ваш учебный проект (копия приложения + ваши пакеты тем) целиком живёт в вашем каталоге и переживает обновления плагина. Покрыты девять сценариев под ключ: развёртывание, новая тема, ежедневная учёба, разбор ошибок, подкасты, генерация курсов, проверка и деплой — см. [`docs/study-coach.md`](docs/study-coach.md).
...
## 🧭 Не знаете, за что взяться? `/study-coach`
