...
# установите ai-study-kit и скажите «хочу выучить X» (или /ai-study-kit) в новой сессии
```
...
## 🧭 Не знаете, за что взяться? `/ai-study-kit`
...
| [`docs/ai-study-kit.ru.md`](docs/ai-study-kit.ru.md) | `/ai-study-kit`: установка, маршрутизация, расширение |
...
pnpm run skill:install    # установить команду /ai-study-kit
