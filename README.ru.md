...
В zcode / Claude Code можно установить и через **маркетплейс плагинов**: добавьте маркетплейс `https://github.com/jerryjiao/ai-study-kit` и установите `study-coach` — дальнейшие обновления skill приходят вместе с обновлением маркетплейса, без переустановки.
