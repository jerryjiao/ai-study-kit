...
Предпочитаете вручную, без агента? Каждому инструменту нужна своя копия. Плагин везёт полный исходный код приложения, клонировать репозиторий не нужно; агент проведёт вас от нуля до работающего учебного сайта, генерируя вопросы и курсы по пути.
