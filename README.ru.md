...
| [`docs/ai-study-kit.md`](docs/ai-study-kit.md) | `/ai-study-kit`: установка, маршрутизация, расширение (на китайском) |
