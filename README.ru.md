...
Ваш учебный проект (копия приложения + ваши пакеты тем) целиком живёт в вашем каталоге и переживает обновления плагина. Покрыты девять сценариев под ключ: развёртывание, новая тема, ежедневная учёба, разбор ошибок, подкасты, генерация курсов, проверка и деплой — см. [`docs/ai-study-kit.md`](docs/ai-study-kit.md).
