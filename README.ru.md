...
Ваш учебный проект (копия приложения + ваши пакеты тем) целиком живёт в вашем каталоге и переживает обновления плагина. Покрыты двенадцать сценариев под ключ, сгруппированных в четыре линии — обучение (тренировка с наставником, спринт перед экзаменом), практика (ежедневная учёба, разбор ошибок, подкасты), контент (новая тема, генерация курсов, правка контента), эксплуатация (развёртывание, проверка, деплой, проекция графа знаний) — см. [`docs/ai-study-kit.ru.md`](docs/ai-study-kit.ru.md).
