...
| **弱考点** | 考点掌握度报告怎么说（mastery-report 确定性派生：弱 N 个、最弱是谁；串讲档案记的错因一并带出，见 state.md §3） |
...
- 弱考点: <EP-03 chmod（未毕业 2）· EP-01 暂存区（档案错因：混淆 add 与 commit）/ 无（全掌握或未开始）>
...
6. 未毕业错题 ≥ 3 → **F4 错题串讲**（错题攒够了，值得 LLM 聚类深挖一轮。点名 mastery 报告最前的弱考点，档案里有错因就引用——理由从「错题多」具体到「EP-03 chmod 连错 2 次，错因：权限位组合不熟」）
