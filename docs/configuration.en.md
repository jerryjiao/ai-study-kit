...
[简体中文](configuration.md) · **English** · [Español](configuration.es.md) · [Русский](configuration.ru.md) · [日本語](configuration.ja.md)
...
The **generated content** language of the three AI CLIs, supporting `zh` (default) / `en` / `es` / `ru` / `ja`:
