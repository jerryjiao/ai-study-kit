...
1. **Зондирование состояния** (только чтение, ≤1 минуты) — тема, объём вопросов/карточек/курсов/разборов, прогресс ответов, невыпущенные ошибки, карточки к повторению, пройденные уроки, слабые цели устного опроса (выводятся из журнала попыток), сессии сопровождения и дата экзамена, конфигурация ИИ, поднят ли бэкенд; если передан путь к графу знаний — ещё и сигналы графа (четыре состояния узлов, отношения предпосылок — см. F12).
