...
| `/study-coach` | Сесть и учиться: прямой вход в тренировку (F10 открыть/продолжить; на старте докладывает «что отрабатывать сегодня и почему») |
...
| `/study-podcast` | Прямой вход в подкаст (F5, превращает учебный материал в аудио с двумя ведущими для дороги) |
