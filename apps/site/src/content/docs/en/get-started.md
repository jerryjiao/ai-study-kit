...
**In one sentence**: this is a scaffold, not a question bank. Questions can be past papers you collect, ones you write by hand, or a full set generated by an AI agent — install [`/study-coach`](/ai-study-kit/ai/study-coach/) and just ask; the flow is described in [Make It Yours](/ai-study-kit/en/your-theme/) under "Let an AI agent write the questions for you". Once questions are in JSON, the tool adds courses, flashcards, wrong-answer analytics and review scheduling.
