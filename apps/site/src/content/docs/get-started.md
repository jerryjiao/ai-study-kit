...
项目不带现成题库，题目可以是收集的真题，也可以让 AI agent 替你产——装好 [`/ask-coach`](/ai-study-kit/ai/ai-study-kit/) 后说一句「帮我给这个主题产一套题库」，流程见[换成你的主题](/ai-study-kit/your-theme/)的「让 AI agent 替你产题」。有了题目，课程、闪卡、错题本和复习调度由它补齐。
