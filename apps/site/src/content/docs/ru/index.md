...
<section class="ask-section">
  ...
  <div class="ask-feats">
    ...
    <div class="ask-feat"><div class="ico">🎧</div><b>Подкасты</b><span>Любой учебный материал превращается в аудио с двумя ведущими для дороги</span></div>
  </div>
</section>
...
<section class="ask-section">
  <div class="ask-section-head">
    ...
    <p>Сменить тему, сгенерировать курсы, пройти тест, разобрать ошибки, задеплоить — эти команды запоминать не нужно, встроенный /ask-coach спланирует всё сам</p>
  </div>
  <div class="ask-flow">
