...
- The coach's voice discipline (the conversational-register base in `skills/references/voice.md`) is distilled and rewritten from [辞达 (cida)](https://github.com/mizzlelover/cida) by 谁是专家 (mizzlelover), MIT License; the decision trail is in [`docs/adr/0008-distill-rewrite-not-runtime-dep.md`](docs/adr/0008-distill-rewrite-not-runtime-dep.md)
